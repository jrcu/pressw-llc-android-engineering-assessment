...
We don't care what you use on the backend as long as it's Node/TypeScript-based so our team can maintain it. For the frontend, keep it simple - we'll probably rebuild it anyway when we have a design system.
